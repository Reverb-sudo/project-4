...
def test_brevet5():
    ...
    checkpoints = {
        0: (start_time, start_time.shift(hours=1)),
        10: (start_time.shift(minutes=35), start_time.shift(hours=2)),
        114: (start_time.shift(hours=1,minutes=28), start_time.shift(hours=3,minutes=30)),
        212: (start_time.shift(hours=5,minutes=53), start_time.shift(hours=13,minutes=20)),
        341: (start_time.shift(hours=9), start_time.shift(hours=20)),
        454: (start_time.shift(hours=12,minutes=8), start_time.shift(hours=24+2,minutes=40)),
        536: (start_time.shift(hours=15,minutes=28), start_time.shift(hours=24+9,minutes=20)),
        636: (start_time.shift(hours=18,minutes=48), start_time.shift(hours=24+16)),
        875: (start_time.shift(hours=24+1,minutes=57), start_time.shift(hours=48+9,minutes=30)),
        1000: (start_time.shift(hours=24+9,minutes=5), start_time.shift(hours=72+3))
    }
